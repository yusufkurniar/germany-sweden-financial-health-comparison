...
This plot shows the trends in median EBIT margin from 2018 to 2021 for key German industries. It highlights how profitability evolved through the pre-pandemic and pandemic periods, with each line representing an industry. Clear labels mark the industries on the right, making it easy to compare their performance trajectories. The visualization reveals that sectors like healthcare and information & communication maintained or improved profitability, while industries such as accommodation & food faced more volatility and declines during the pandemic. This comparison underscores varying financial resilience across industries amid COVID-19 challenges.
...
```
The summary statistics show that firms’ liquidity positions remained relatively stable throughout 2018–2021, with median current ratios hovering around 1.8–1.9× and a consistent spread (IQR ≈ 2.5). In contrast, profitability (measured by ROA) dropped sharply during the pandemic—from 4.1% in 2018 to just 2.3% in 2020—before showing a slight recovery in 2021. The increasing IQR for ROA suggests that profitability outcomes became more dispersed, indicating uneven recovery across firms and industries.
...
Median profitability remained broadly stable across all firms (EBIT/EBITDA medians barely changed), but industry patterns varied. The largest median improvements in EBITDA margin were seen in Technology and Accommodation & Food, while Administrative & Support, Financials, Construction, and parts of Consumer Services experienced clear median declines. Health Care continued as a structurally high-margin outlier with little change in its median. Although typical profitability (medians) stayed relatively stable, the distribution widened: ROA/ROE and net income showed more firms with losses or very low returns in 2020 – 2021. In short, the pandemic increased downside risk and variation, creating winners and losers by industry, even though the overall profitability for the average firm remained roughly the same.
